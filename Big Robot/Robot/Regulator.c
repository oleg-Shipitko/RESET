...
char lastPoint = 0;// последн€€ активна€ точка в очереди
...
float standVel[5] = {0.6, 0.6, -0.6, 2.0, 2.5};                                       //удержание заданного положени€
...
float standRot[5] = {4.0, 4.0, -1.0, 2.0, 2.5};                                       //удержание заданного положени€
...
void initRegulators(void)  // инициализаци€ регул€торов
{
...
//Track Regulator settings______________________________________________________
  ...
  {  //регул€тор угловой скорости
    ...
    //OrtoPos //регул€тор ошибки отклонени€ от траектории
  {
        ortoPos.p_k = 1.8;
        ortoPos.i_k = 0.05;
        ortoPos.d_k = 0.0;
...
////////////////////////////////////////////////////////////////////////////////
void FunctionalRegulator(float *V_target, float *Coord_target, float *Coord_cur, float *V_out) // расчет требуемой скорости вращени€ двигателей
{
...
////////////////////////////////////////////////////////////////////////////////
void pidCalc(PidStruct *pid_control)  //рассчет ѕ»ƒ
...
//Low level pid target values are set here__________________________________
  ...
  for(i =0; i < 4; i++)
  {
    ...
    wheelsPidStruct[i].current = motorSpeed[i]; // текущие занчени€ скоростей колес
