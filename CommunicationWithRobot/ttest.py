...
def p_trans(combined):
	x_rob = [point[1] * math.cos(angle5(point[0])) for point in combined]
	y_rob = [point[1] * math.sin(angle5(point[0])) for point in combined]
	return x_rob, y_rob
...
def update_di2(answer, pose):		
	...
	#print len(combined)
	x_glob, y_glob = point_transform(combined, pose)
	return combined, angle, polar_graph, x_glob, y_glob
