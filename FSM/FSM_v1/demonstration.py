...
MoveToPointState(1.08, 0.4375, -1.57),
CorrectCoordinatesState_2(1.08, -0.03, -1.57),#near cube
MoveToPointState(1.085, 0.26, -1.57),
OpenCubesManipulatorState(185),
MoveToPointState(0.94, 0.26, -1.57),
...
SwitchOnVibrationTableState(),
SwitchOnBeltsState(),
MoveToPointState(0.9355, 0.915, -3.14),
MoveToPointState(0.9055, 0.915, -3.14),
MoveToPointState(0.8055, 0.915, -3.14),
