...
class CloseDoorsState(object):
    ...
    def __init__(self): 
        self.future_tasks = [
            SuperFastMoveToIntermediaryPointTask(0.6, 0.47, -1.57),
...
class TestState(object):
    ...
    def __init__(self): 
        self.future_tasks = [
            FastMoveToFinalPointTask(0.48, 0.48, 0.0),
            SlowMoveToFinalPointTask(0.1725, 0.72, 0.0)]
...
collect_cubes_options = [{ 
        ...
        'tasks_list': [
            ...
            #FastMoveToIntermediaryPointTask(0.45, 0.45, -3.14),
            FastMoveToFinalPointTask(0.6, 0.6, -3.14)]},
        { 
        'priority': 2, 
        'tasks_list': [
            SuperFastMoveToIntermediaryPointTask(1.48, 0.48, -1.57),
            SlowMoveToFinalPointTask(1.48, 0.43, -1.57),
            TakeCubesTask(1),
            SlowMoveToFinalPointTask(1.48, 0.38, -1.57),
            TakeCubesTask(3)]},
        { 
        'priority': 1, 
        'tasks_list': [
            SuperFastMoveToIntermediaryPointTask(0.45, 0.47, 0),
            FastMoveToFinalPointTask(2.0, 0.47, -1.57),
            WaitTimeTask(10),
            SlowMoveToFinalPointTask(2.105, 0.47, -1.57),
            SlowMoveToFinalPointTask(2.105, 0.31, -1.57),
            TakeCubesTask(1),
            TakeCubesTask(3),
            FastMoveToIntermediaryPointTask(2.105, 0.47, -1.57)]}]
