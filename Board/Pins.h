...
/////////////////////////////////////////////////////////////////////////////
#define GENERAL_PIN_0            pin_id(PORTA,0)                //ADC12_IN1//
#define GENERAL_PIN_1            pin_id(PORTA,1)                //ADC12_IN2//
#define GENERAL_PIN_2            pin_id(PORTA,2)                //ADC12_IN3//
#define GENERAL_PIN_3            pin_id(PORTA,3)                //ADC12_IN4//
#define GENERAL_PIN_4            pin_id(PORTB,0)                //ADC12_IN5//
#define GENERAL_PIN_5            pin_id(PORTB,1)                //ADC12_IN6//
#define GENERAL_PIN_6            pin_id(PORTC,1)                //ADC12_IN7//
#define GENERAL_PIN_7            pin_id(PORTC,2)                //ADC12_IN8//
#define GENERAL_PIN_8            pin_id(PORTC,4)                //ADC12_IN9//
#define GENERAL_PIN_9            pin_id(PORTC,5)                //ADC12_IN10//
