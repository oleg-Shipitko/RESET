...
if __name__ == '__main__':
    ...
    while True:
        ...
        small_robot = app.canvas.create_polygon(draw_big(d,e,f), outline = "red", fill = "white", width = 5)
        small_robot_lidar = app.canvas.create_polygon(draw_big(a,b,c), outline = "gray", fill = "gray", width = 5)
        small_robot_line = app.canvas.create_line(draw_lines(d,e,f), fill = "red", width = 5)
