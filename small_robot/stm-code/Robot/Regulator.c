...
pathPointStr points[POINT_STACK_SIZE]={ {0.0, 0.0, .0, NULL,NULL,0,stopVelFast,normalRotFast,0,1 },  //Стек точек траектории
...
//PID Regulator settings________________________________________________________
  ...
  {
  	wheelsPidStruct[i].p_k = 2.00; //5.0
  	wheelsPidStruct[i].i_k = 0.5; //1
  	wheelsPidStruct[i].d_k = 0.3; //0.5
